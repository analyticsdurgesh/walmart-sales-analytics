...
select
    date_format(date, '%Y-%m-01') as month,    -- rewrite the date as text like 2010-02-01, the 1st of its month
...
group by date_format(date, '%Y-%m-01'); -- one output row per month
